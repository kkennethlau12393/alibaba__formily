...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From yarn.lock, yarn@1.22.22
corepack enable

# step 2: dependencies, from your lockfile. From yarn.lock, yarn@1.22.22
